 ...
 */
package com.mycompany.ceptransportsys.source;
 ...
 * @author bisht
 */
public class MonitoringTrafficEventSource extends RichParallelSourceFunction<MonitoringTrafficEvent> {
private boolean running = true;
  private String status;
    ...
    public MonitoringTrafficEventSource(){}
    ...
    @Override
    public void run(SourceContext<MonitoringTrafficEvent> ctx) throws Exception {
